locals {
  ...
  is_flex_shape       = var.vm_compute_shape == "VM.Standard.A1.Flex" ? [var.vm_flex_shape_ocpus] : []
  is_spoke_flex_shape = var.spoke_vm_compute_shape == "VM.Standard.A1.Flex" ? [var.spoke_vm_flex_shape_ocpus] : []
